...
| 13 | [13-mainwindow-state-management.md](13-mainwindow-state-management.md) | Extract state management to ViewModel | 4-5 hours | **11 sub-steps (13a-13k)** | 🔶 IN PROGRESS (5/11 - state properties complete) |
